...
// console.log(friends);   // ['진승', ' 혜미', ' 송이'] => 배열이 잘리게 된다.

// ! 배열 요소 변경
friends[0] = '선범';
console.log(friends); // ['선범', ' 혜미', ' 송이'..]

// ! 배열 요소 추가
// 배열에 앞 요소 추가
let unshift = friends.unshift('진승');
console.log(friends); // ['진승', '선범', ' 혜미'..]

// 배열의 뒤 요소 추가
let push = friends.push('동균');
console.log(friends); // ['진승', '선범',.. '동균']
...
// * 배열 복사
// ?.전개 구문 :: spread syntax => 얕은 복사
let copiedArray = [...friends];
console.log(copiedArray);

// ? slice 메서드
let copiedArray1 = friends.slice();
console.log(copiedArray1);

// ? toSorted :: 정렬함과 동시에 배열을 복사해서 내보낸다.
let copiedArray2 = friends.toSorted();
console.log(copiedArray2);

// ? array.from :: 유사배열을 배열로 만들기
